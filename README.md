...
This Terms of Service Agreement (the "Agreement") is entered into between [LukeNightstar] ("Bot Owner") and the user ("User") of the [새참이.ts] [SaeCham.ts] Discord bot (the "Bot").
